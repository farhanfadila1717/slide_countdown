...
class MinutesSeparatedDigit extends BaseDigitsSeparated {
  ...
  @override
  State<MinutesSeparatedDigit> createState() => _MinutesSeparatedDigitState();
}

class _MinutesSeparatedDigitState extends State<MinutesSeparatedDigit> {
  @override
