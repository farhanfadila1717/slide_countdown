...
class SecondsSeparatedDigit extends BaseDigitsSeparated {
  ...
  @override
  State<SecondsSeparatedDigit> createState() => _SecondsSeparatedDigitState();
}

class _SecondsSeparatedDigitState extends State<SecondsSeparatedDigit> {
  @override
  Widget build(BuildContext context) {
    final duration = widget.duration;
    if (duration.inSeconds < 1 && !widget.showZeroValue) {
    ...
    final separator = Separator(
      ...
      show: widget.separatorType == SeparatorType.title,
      separator: widget.separatorType == SeparatorType.title
          ? widget.durationTitle.seconds
          : widget.separator ?? ':',
